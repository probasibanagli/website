  ...
  return (
    <AdminModulePage
      ...
      formFields={[
        ...
        { key: 'rating', label: 'Google Rating (e.g., 4.5)' },
        { key: 'bengali_friendly', label: 'Bengali Friendly', type: 'checkbox' },
        { key: 'verified', label: 'Verified Listing', type: 'checkbox' },
        { key: 'specialties', label: 'Specialties (comma-separated)' },
        { key: 'google_maps_url', label: 'Google Maps Link' },
        { key: 'map_embed_code', label: 'Map Embed Code (Paste HTML from Google Maps)' },
