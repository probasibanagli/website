...
import { Search, MapPin, Phone, Clock, CheckCircle2, Stethoscope } from 'lucide-react';
    ...
    <div className="min-h-screen bg-surface">
      <div className="bg-white border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold font-display text-text-primary">Hospital Finder</h1>
          <p className="mt-2 text-text-muted">Find hospitals and emergency services in Tamil Nadu.</p>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-3">
            <div className="relative flex-1 min-w-[200px] max-w-sm">
              ...
              <input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search hospitals..." className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-border text-sm focus:outline-none focus:ring-2 focus:ring-primary/30" />
            </div>
