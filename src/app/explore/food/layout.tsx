...
export const metadata: Metadata = {
  ...
  description: 'Discover authentic Bengali restaurants, sweet shops, tiffin services and home delivery in Chennai, Coimbatore & Vellore. Zomato & Swiggy links included.',
