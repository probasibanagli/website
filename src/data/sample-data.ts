...
export const sampleCommunityGroups: CommunityGroup[] = [
  // ΓöÇΓöÇ Chennai ΓÇô Cultural Associations ΓöÇΓöÇ
  ...
  // ΓöÇΓöÇ Coimbatore ΓöÇΓöÇ
  { id: '18', name: 'The Bengali Association Coimbatore', platform: 'website', city: 'Coimbatore', region: 'tamil_nadu', description: 'The Bengali Association Coimbatore ΓÇô cultural body for Bengalis in Coimbatore.', member_count: 1500, join_url: 'https://www.bengaliassociationcoimbatore.com/', website_url: 'https://www.bengaliassociationcoimbatore.com/', facebook_url: 'https://www.facebook.com/tbacbe', category: 'cultural' },
  { id: '19', name: 'Durgapuja Ramakrishna Math Coimbatore', platform: 'website', city: 'Coimbatore', region: 'tamil_nadu', description: 'Ramakrishna Math Coimbatore ΓÇô Durga Puja and spiritual activities.', member_count: 2000, join_url: 'https://chennaimath.org/', website_url: 'https://chennaimath.org/', facebook_url: 'https://www.facebook.com/srkmv/', instagram_url: 'https://www.instagram.com/ramakrishnamath', category: 'religious' },
  { id: '20', name: 'SNV Kalyana Mandapam', platform: 'website', city: 'Coimbatore', region: 'tamil_nadu', description: 'Sri SNV Kalyana Mandapam ΓÇô Bengali community venue in Coimbatore.', member_count: 800, join_url: 'https://srisnvkalyanamandapam.in/', website_url: 'https://srisnvkalyanamandapam.in/', category: 'cultural' },

  // ΓöÇΓöÇ Trichy ΓöÇΓöÇ
  { id: '21', name: 'The Bengali Association Trichy', platform: 'website', city: 'Tiruchirappalli', region: 'tamil_nadu', description: 'The Bengali Association Trichy ΓÇô cultural association for Bengalis in Tiruchirappalli.', member_count: 1000, join_url: 'https://www.thebengalassociation.com/', website_url: 'https://www.thebengalassociation.com/', facebook_url: 'https://www.facebook.com/profile.php?id=61558647747693', instagram_url: 'https://www.instagram.com/bengaliassociationtrichy/', category: 'cultural' },

  // ΓöÇΓöÇ Puducherry ΓöÇΓöÇ
  { id: '22', name: 'Bangabharathi Puducherry', platform: 'website', city: 'Puducherry', region: 'tamil_nadu', description: 'Bangabharathi ΓÇô Bengali cultural organisation in Puducherry.', member_count: 600, join_url: 'https://bangabharati.weebly.com/', website_url: 'https://bangabharati.weebly.com/', facebook_url: 'https://www.facebook.com/BangabharathiPuducherry', category: 'cultural' },

  // ΓöÇΓöÇ Madurai ΓöÇΓöÇ
  { id: '23', name: 'Durgapuja Ramakrishna Math Madurai', platform: 'website', city: 'Madurai', region: 'tamil_nadu', description: 'Ramakrishna Math Madurai ΓÇô Durga Puja and spiritual activities.', member_count: 1200, join_url: 'https://chennaimath.org/', website_url: 'https://chennaimath.org/', category: 'religious' },

  // ΓöÇΓöÇ ProbasiBangali ΓöÇΓöÇ
...
export const sampleMatrimonialProfiles: MatrimonialProfile[] = [
  ...
  },
  {
    ...
    about_me: 'Passionate about travel, art and Bengali cuisine. I love exploring new places and trying local foods. Dancing is my stress-buster ΓÇö I\'ve trained in Rabindra Nritya. Looking for a life partner who respects Bengali traditions while having a progressive outlook on life.',
  ...
  },
  {
    ...
    about_me: 'Working in the manufacturing sector. Sports enthusiast ΓÇö I play cricket every weekend. Love reading Bengali literature and listening to Rabindra Sangeet.',
  ...
  },
  {
    ...
    about_me: 'CA working in Coimbatore. I am deeply connected to my Bengali roots ΓÇö I sing Rabindra Sangeet and cook authentic Bengali food. Looking for someone who shares these values.',
...
export const sampleEvents: CommunityEvent[] = [
  ...
  { id: '3', title: 'Saraswati Puja ΓÇö VIT Campus', description: 'Saraswati Puja organized by VIT Bengali Students Club. Pushpanjali, cultural program, and khichuri bhog.', event_date: '2026-01-30', city: 'Vellore', venue: 'VIT Auditorium', organizer: 'VIT Bengali Students Club', contact: '9876543233', category: 'religious', community_group_id: '5' },

  // ΓöÇΓöÇ February ΓöÇΓöÇ
  ...
  { id: '7', title: 'Bengali Food Festival ΓÇö Coimbatore', description: 'Two-day Bengali food mela with stalls serving luchi-alur dom, mishti doi, rosogolla, kosha mangsho, and more.', event_date: '2026-03-14', city: 'Coimbatore', venue: 'Hotel Residency Towers', organizer: 'Coimbatore Banga Samaj', contact: '9876543234', category: 'cultural', community_group_id: '6' },
  { id: '8', title: 'Student Community Meetup ΓÇö March', description: 'Monthly meetup for Bengali students across Tamil Nadu. Academic tips, career guidance, and fun.', event_date: '2026-03-22', city: 'Chennai', venue: 'SRM Campus, Potheri', organizer: 'Bengali Students TN', contact: '9876543237', category: 'social', community_group_id: '2' },
  ...
  { id: '10', title: 'Poila Boishakh ΓÇö Coimbatore', description: 'New Year celebration in Coimbatore. Cultural program, traditional songs, and community feast.', event_date: '2026-04-14', city: 'Coimbatore', venue: 'Town Hall, RS Puram', organizer: 'Bangali Adda Coimbatore', contact: '9876543234', category: 'festival', community_group_id: '6' },
  ...
  { id: '13', title: 'Rabindra Jayanti ΓÇö VIT', description: 'Rabindra Jayanti celebration at VIT. Recitation, songs, and drama by Bengali students.', event_date: '2026-05-09', city: 'Vellore', venue: 'VIT Auditorium', organizer: 'VIT Bengali Students Club', contact: '9876543233', category: 'cultural', community_group_id: '5' },
  ...
  // ΓöÇΓöÇ June ΓöÇΓöÇ
  { id: '15', title: 'Community Meetup ΓÇö June', description: 'Monthly meetup for Bengali families. Food, fun, networking, and kids activities.', event_date: '2026-06-07', city: 'Chennai', venue: 'Savera Hotel, Mylapore', organizer: 'Bengalis in Chennai', contact: '9876543230', category: 'social', community_group_id: '1' },
  ...
  { id: '19', title: 'Student Orientation ΓÇö New Batch', description: 'Welcome session for new Bengali students arriving in Tamil Nadu. City guide, tips, and networking.', event_date: '2026-07-25', city: 'Chennai', venue: 'IIT Madras Campus', organizer: 'Bengali Students TN', contact: '9876543237', category: 'social', community_group_id: '2' },

  // ΓöÇΓöÇ August ΓöÇΓöÇ
  ...
  { id: '22', title: 'Bengali Cooking Workshop', description: 'Learn authentic Bengali cooking ΓÇö shorshe ilish, chingri malaikari, mishti. Hands-on workshop with expert chefs.', event_date: '2026-08-23', city: 'Coimbatore', venue: 'Hotel Residency Towers', organizer: 'Bengalis in Coimbatore', contact: '9876543234', category: 'social', community_group_id: 'ig-4' },

  // ΓöÇΓöÇ September ΓöÇΓöÇ
  { id: '23', title: 'Mahalaya ΓÇö Dawn Ceremony', description: 'Early morning Mahalaya celebration with Birendra Krishna Bhadra\'s Mahishasura Mardini live relay, followed by breakfast.', event_date: '2026-09-21', city: 'Chennai', venue: 'Bengali Club, Anna Nagar', organizer: 'Chennai Bengali Association', contact: '9876543230', category: 'religious', community_group_id: 'web-2' },
  ...
  // ΓöÇΓöÇ October ΓöÇΓöÇ
  { id: '25', title: 'Durga Puja 2026 ΓÇö Maha Shasthi', description: 'Grand Durga Puja begins! Bodhon, Amontron, and Adhivas. Five days of cultural programs, food stalls, dhunuchi naach.', event_date: '2026-10-01', city: 'Chennai', venue: 'Deshapriya Park, T.Nagar', organizer: 'Chennai Bengali Association', contact: '9876543230', category: 'festival', community_group_id: 'web-2' },
  { id: '26', title: 'Durga Puja 2026 ΓÇö Maha Saptami', description: 'Maha Saptami celebrations with Nabapatrika puja, pushpanjali, and cultural programs.', event_date: '2026-10-02', city: 'Chennai', venue: 'Deshapriya Park, T.Nagar', organizer: 'Chennai Bengali Association', contact: '9876543230', category: 'festival', community_group_id: 'web-2' },
  { id: '27', title: 'Durga Puja 2026 ΓÇö Maha Ashtami', description: 'Maha Ashtami with Kumari Puja, Sandhi Puja, and grand celebrations.', event_date: '2026-10-03', city: 'Chennai', venue: 'Deshapriya Park, T.Nagar', organizer: 'Chennai Bengali Association', contact: '9876543230', category: 'festival', community_group_id: 'web-2' },
  { id: '28', title: 'Durga Puja 2026 ΓÇö Maha Navami', description: 'Maha Navami with Homa, Bali, and grand cultural evening. Dhunuchi naach competition.', event_date: '2026-10-04', city: 'Chennai', venue: 'Deshapriya Park, T.Nagar', organizer: 'Chennai Bengali Association', contact: '9876543230', category: 'festival', community_group_id: 'web-2' },
  { id: '29', title: 'Durga Puja 2026 ΓÇö Bijoya Dashami', description: 'Bijoya Dashami with Devi Bisarjan, Sindur Khela, and emotional Bijoya Sammilani.', event_date: '2026-10-05', city: 'Chennai', venue: 'Deshapriya Park, T.Nagar', organizer: 'Chennai Bengali Association', contact: '9876543230', category: 'festival', community_group_id: 'web-2' },
  { id: '30', title: 'Durga Puja ΓÇö Coimbatore', description: 'Durga Puja celebrations in Coimbatore. Three-day cultural extravaganza with pandal, food, and entertainment.', event_date: '2026-10-02', city: 'Coimbatore', venue: 'Town Hall, RS Puram', organizer: 'Bangali Adda Coimbatore', contact: '9876543234', category: 'festival', community_group_id: '6' },
  ...
  { id: '34', title: 'Bengali Heritage Walk ΓÇö Chennai', description: 'Guided heritage walk exploring Bengali historical connections in Chennai. Visit temples, old Bengali quarters, and heritage buildings.', event_date: '2026-11-15', city: 'Chennai', venue: 'Fort St George (Start Point)', organizer: 'Probasi Bangali TN', contact: '9876543238', category: 'cultural', community_group_id: 'ig-2' },
  ...
  { id: '37', title: 'Community Picnic ΓÇö Year End', description: 'Annual year-end picnic for Bengali families. Games, BBQ, live music, and fun activities for kids.', event_date: '2026-12-13', city: 'Chennai', venue: 'Muttukadu Boat House', organizer: 'Bengalis in Chennai', contact: '9876543230', category: 'social', community_group_id: '1' },
