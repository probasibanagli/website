...
export const TAMIL_WORDS = [
  ...
  { meaning: 'Where should I go?', pronunciation: 'Enge poganum?', tamil: 'எங்கே போகணும்?', bengali: 'এঙ্গে পোগানুম?' },
  { meaning: 'How should I go?', pronunciation: 'Eppadi poganum?', tamil: 'எப்படி போகணும்?', bengali: 'এপ্পাডি পোগানুম?' },
  { meaning: 'Where is this?', pronunciation: 'Idhu enge irukku?', tamil: 'இது எங்கே இருக்கு?', bengali: 'ইধু এঙ্গে ইরুক্কু?' },
  { meaning: 'How much is this?', pronunciation: 'Idhu evvalavu?', tamil: 'இது எவ்வளவு?', bengali: 'ইধু এভভালাভু?' },
  { meaning: 'How long will it take?', pronunciation: 'Evvalavu neram aagum?', tamil: 'எவ்வளவு நேரம் ஆகும்?', bengali: 'এভভালাভু নেরাম আগুম?' },
  { meaning: 'Which bus goes there?', pronunciation: 'Endha bus pogum?', tamil: 'எந்த பஸ் போகும்?', bengali: 'এন্দা বাস পোগুম?' },
  { meaning: 'Does this bus go there?', pronunciation: 'Indha bus poguma?', tamil: 'இந்த பஸ் போகுமா?', bengali: 'ইন্দা বাস পোগুমা?' },
  { meaning: 'Where should I get down?', pronunciation: 'Enge iranganum?', tamil: 'எங்கே இறங்கணும்?', bengali: 'এঙ্গে ইরাঙ্গানুম?' },
  { meaning: 'Where should I board?', pronunciation: 'Enge eranum?', tamil: 'எங்கே ஏறணும்?', bengali: 'এঙ্গে এরানুম?' },
  { meaning: 'Where do I get the ticket?', pronunciation: 'Ticket enge edukkanum?', tamil: 'டிக்கெட் எங்கே எடுக்கணும்?', bengali: 'টিকিট এঙ্গে এডুক্কানুম?' },
  { meaning: 'Is this the correct route?', pronunciation: 'Idhu sariyana vazhiya?', tamil: 'இது சரியான வழியா?', bengali: 'ইধু সারিয়ানা ভালিয়া?' },
  { meaning: 'How much farther?', pronunciation: 'Innum evvalavu dhooram?', tamil: 'இன்னும் எவ்வளவு தூரம்?', bengali: 'ইন্নুম এভভালাভু ধুরম?' },
  { meaning: 'Can we walk there?', pronunciation: 'Nadandhu pogalama?', tamil: 'நடந்து போகலாமா?', bengali: 'নাদান্দু পোগালামা?' },
  { meaning: 'Can we get an auto?', pronunciation: 'Auto kidaikkuma?', tamil: 'ஆட்டோ கிடைக்குமா?', bengali: 'অটো কিডাইক্কুমা?' },
  { meaning: 'Is there a place to eat here?', pronunciation: 'Inge saapida idam irukka?', tamil: 'இங்கே சாப்பிட இடம் இருக்கா?', bengali: 'ইங்கே সাপ্পিডা ইডাম ইরুক্কা?' },
  ...
  { meaning: 'Money', pronunciation: 'Kaasu', tamil: 'காசு', bengali: 'কাসு' },
