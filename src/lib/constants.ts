...
export const TAMIL_WORDS = [
  ...
  { tamil: 'Kaasu / Panam', meaning: 'Money', script: 'காசு / பணம்' },
  ...
  { tamil: 'Perundhu / Bus', meaning: 'Bus', script: 'பேருந்து / பஸ்' },
  { tamil: 'Bus nilayam', meaning: 'Bus station', script: 'பஸ் நிலையம்' },
  { tamil: 'Rayil / Train', meaning: 'Train', script: 'ரயில்' },
  { tamil: 'Rayil nilayam', meaning: 'Railway station', script: 'ரயில் நிலையம்' },
  { tamil: 'Ticket irukka?', meaning: 'Are tickets available?', script: 'டிக்கெட் இருக்கா?' },
  { tamil: 'Vandi', meaning: 'Vehicle', script: 'வண்டி' },
  { tamil: 'Vali enga irukku?', meaning: 'Where is the way?', script: 'வழி எங்க இருக்கு?' },
  { tamil: 'Niruthu / Nillu', meaning: 'Stop', script: 'நிறுத்து / நில்லு' },
  { tamil: 'Naan poganum', meaning: 'I need to go', script: 'நான் போகணும்' },
